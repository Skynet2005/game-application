// src/components/cyber-rant/shared/CommunityProfileHeader.tsx
...
const CommunityProfileHeader = ({ accountId, authUserId, name, username, imgUrl, bio, type }: Props) => {
  return (
    <div className="flex w-full flex-col justify-start text-neutral-950 dark:text-neutral-300">
      <div className="flex items-center justify-between">
        ...
        <Link href="/cyber-rant/communities/community-onboarding">
        ...
        {accountId === authUserId && type !== 'User' && (
          <Link href="/cyber-rant/communities/edit">
            <Button className="cyberrant-gradient flex cursor-pointer gap-3 px-4 py-2 border rounded-xl border-neutral-950 dark:border-sky-900 text-neutral-950 dark:text-sky-800 w-fit">
              <Image
