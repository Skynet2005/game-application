...
import { Player } from '@/components/battle-simulator/models/Player';
import { Battle } from '@/components/battle-simulator/models/Battle';
import { Infantry, Lancer, Marksmen } from '@/components/battle-simulator/models/Troop';
